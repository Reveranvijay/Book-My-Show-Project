class movie_tickets:
    def __init__(self):
        print(" WELCOME TO VIJAY'S MOVIE ".center(80,'-'))
    ...
    def show_seats(self):
        print(" SCREEN IS ON THIS SIDE ".center(80,'-'))
        print('Seats : ')
        for i in self.row:
            for j in i:
                print(j,end = ' ')
            print()
    def buy_ticket(self):
        print(" BOOKING COUNTER ".center(80,'-'))
        print('Please select the seats between {} rows and {} columns'.format(self.rows,self.columns))
        ...
        if (self.r,self.c) in self.details:
            ...
            if self.last == 'yes':
                if self.total_tickets<=60:
                    self.opinion = input('Your ticket price is 10$, if you want to confirm, Please type Yes/No: ')
                    ...
                    if self.rows%2==0:
                        ...
                        if self.r<=((self.rows//2)):
                            ...
                            self.opinion = input('Your ticket price is 8$, if you want to confirm, Please type Yes/No: ')
                            while self.opinion.isalpha()==False:
                                print('Please choose your options in alphabets only!')
                                self.opinion = input('Your ticket price is 8$, if you want to confirm, Please type Yes/No: ')
                                continue
                ...
                pass
    def statistics(self):
        print(" TOTAL INCOME FOR VIJAY'S MOVIE ".center(80,'-'))
        self.total = 0
